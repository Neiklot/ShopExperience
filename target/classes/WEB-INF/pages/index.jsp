		...
		jQuery("#dataTableShops").jqGrid(
				{
					...
					caption : "Tiendas",
					onSelectRow : function() {
						var selr = jQuery('#dataTableShops').jqGrid(
								'getGridParam', 'selrow');
						if (selr)
							popupwindow(selr);
						else
	...
	<div class="bodyPage">
		<div class="buttons">
			<td style='margin-top: 10px; padding: 45px;'><a
				title='New client' class='boton' href="<c:url value="/registerClient" />">
					<span></span>
			</a></td>
			<td style='margin-top: 10px; padding: 45px;'><a title='New Shop'
				class='boton' href="<c:url value="/register" />"> <span></span></a>
			</td>
			<td style='margin-top: 10px; padding: 45px;'><a title='New User'
				class='boton' href="<c:url value="/register" />"> <span></span></a>
			</td>
		</div>
